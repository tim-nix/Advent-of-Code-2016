...
#
# What is the sum of the sector IDs of the real
# rooms?
...
if __name__ == '__main__':
   ...
   for r in rooms:
      ...
      # If it matches, then add the sector ID to
      # the sum.
      if checksum == r[1]:
         sum_IDs += r[2]
   
   # Display the sum of the sector IDs for real
   # rooms.
   print("Sum of real room sector IDs = " + str(sum_IDs))
