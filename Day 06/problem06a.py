...
# figure out which character is most frequent for
# each position; that is, the character most
...
if __name__ == '__main__':
   ...
   message = ''
   for c in columns:
      # Find the most occurring character from the
      # list and append it to the message.
      message += max(set(c), key=c.count)
