...
# higher-value chip.
#
# Based on the instructions, what is the number of
# the bot that is responsible for comparing
...
if __name__ == '__main__':
   ...
   # Find and display the bot responsible for
   # comparing the two check values (specified in
   # instructions).
   check1 = 17
   check2 = 61

   for key in bots:
      if (check1 in bots[key]) and (check2 in bots[key]):
         print('The bot ' + str(key) + ' is responsible.')
