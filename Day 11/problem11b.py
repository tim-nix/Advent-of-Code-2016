...
#
# For this problem, there are extra parts on the
# first floor that weren't listed on the record
# outside:
...
if __name__ == '__main__':
   ...
   # Add the following to the first floor based on
   # the problem description:
   # - An elerium generator.
   # - An elerium-compatible microchip.
   # - A dilithium generator.
   # - A dilithium-compatible microchip.
   diagram[0].append(('elerium', 'generator'))
   diagram[0].append(('elerium', 'microchip'))
   diagram[0].append(('dilithium', 'generator'))
   diagram[0].append(('dilithium', 'microchip'))
