...
#
# In this problem, the discs are back in their
# original configuration as if it were time=0
# again, but a new disc with 11 positions and
# starting at position 0 has appeared exactly one
# second below the previously-bottom disc.
#
# With this new disc, and counting again starting
# from time=0 with the configuration in your
# puzzle input, what is the first time you can
...
if __name__ == '__main__':
   ...
   # Add the new disc to the configuration.
   discs.append((11, 0))
