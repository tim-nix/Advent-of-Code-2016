...
#
# The second disk you have to fill has length
# 35651584. Again using the initial state in your
# puzzle input, what is the correct checksum for
# this disk?
...
if __name__ == '__main__':
   ...
   data_string = list(readFile("input16b.txt")[0])
   ...
   # Swapped from using (immutable) strings to
   # using (mutable) lists of characters, making
   # Part Two (perhaps, still slow but) much more
   # efficient (~5.0 seconds).
