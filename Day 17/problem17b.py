...
# distance of the LONGEST path to reach the vault?
...
if __name__ == '__main__':
   ...
   # Keep track of the length of the longest path.
   max_path = 0
   ...
   while len(to_visit) > 0:
      ...
      # compare the path length to the longest
      # found. No exit from this path.
      if current == vault:
         path_length = len(passcode[original_length:])
   ...
   # Display length of the longest path to vault.
   print('Longest path length to vault = ' + str(max_path))
