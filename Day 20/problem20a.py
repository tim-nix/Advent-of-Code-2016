...
# firewall, what is the lowest-valued IP that is
# not blocked? 
...
if __name__ == '__main__':
   ...
   # Display the lowest-valued IP address that is
   # not blocked by the black list.
   print('The lowest available IP is ' + str(ranges[0][1] + 1))
