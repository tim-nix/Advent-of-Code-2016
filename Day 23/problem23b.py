...
# Now you count 12. Place this value in register
# a. What value should be sent to the safe?
...
if __name__ == '__main__':
   ...
   # The brute force approach was too inefficient.
   # Analysis of the execution of the instructions
   # reveal the pattern of the contents of
   # register as a function of the number of eggs.
   ...
   # Analyzing program results with lower values
   # in register a, the following pattern emerges:
   # f(a) = a x (a - 1) x a! + 6935
   result = registers['a']
   result *= (result - 1)
   for i in range(1, registers['a'] - 1):
      result *= i
   # Constant determined from running with lower
   # values in register a.
   result += 6935 

   # Display the contents of the 'a' register.
   print("Register 'a' contents = " + str(result))
