...
#
# Given your actual map, what is the fewest number
# of steps required to start at 0, visit every
...
if __name__ == '__main__':
   ...
   # starting at '0' and ending at '0', calculate
   # the sum of the shortest path between legs.
   min_path = math.inf
   for c in combos:
      # Add '0' as the last stop of the path.
      route = list(c)
      route.append('0')
